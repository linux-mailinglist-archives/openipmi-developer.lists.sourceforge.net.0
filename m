...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	bh=J2cAyyhg8AYzVCt+HRPz3zZDhLC2gSsQvDVj4NmhcSY=; b=dVWhvYagLXsUkYy0ky3uRVS4RV
	QbAm20tJjsKKnuh+shMy5kZprut6FAuDmE7hP862IYhk9S/GkksgVKy254UQTcIVKqa5ry09CfIuy
	YIpAMHXxcwNArDH+bzJZt9z++OmpAwcHaT8s/jua4BNjgw+AiGjk/BU3E55BEIjTIr3k=;
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <openipmi-developer-bounces@lists.sourceforge.net>)
	id 1wQ4CS-0002fI-Pw;
	Thu, 21 May 2026 14:16:36 +0000
Received: from [172.30.29.66] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <kees@kernel.org>) id 1wQ3Wo-0001f3-JI
 for openipmi-developer@lists.sourceforge.net;
 Thu, 21 May 2026 13:33:34 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=ezV5ICAM2va0jVjd8iAniGdLxBSb69xxnF1gv2JwpSY=; b=jGJdM5rSzK59JjOIpcj7anOync
 LDWp8WRDvao7zRBGGn+r6ufWyHHwwks2a3lEqMjRrfGlncQfdFbneRFWEjL5TOhqC9btYb87kSIfB
 wQwrsBanldcTVdAPl2/UwOf0n5aLQwwXP3sZAdMOXrdkZnS25xWUNFr9R4hjEo9zwZ2A=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=ezV5ICAM2va0jVjd8iAniGdLxBSb69xxnF1gv2JwpSY=; b=BPZ1QeqOlC/cNscYbINGNWWDkG
 C6IXNV2MV1r6W0l251RlQh7TFSjCU5gXXagugiSnXgodr6n9zwNWg/xxMX7zHUTUcJdH6lyqkx3IU
 nq7MN07i1l79FsYruD+FKUUM/goMGKCK21lYH0zTmQidZWG2W5lCqkm9l3nvnH/QnfD0=;
Received: from sea.source.kernel.org ([172.234.252.31])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1wQ3Wm-0004O7-ED for openipmi-developer@lists.sourceforge.net;
 Thu, 21 May 2026 13:33:34 +0000
...
X-Spam-Report: Spam detection software,
 ...
 Content preview: From: Pengpeng Hou <pengpeng@iscas.ac.cn> param_array_get()
 appends each element's string representation into the shared sysfs page buffer
 by passing buffer + off to the element getter. That works for getters that
 only write a small bounded string, but param_get_charp() and similar helpers
 format against PAGE_SIZE from the pointer they receive. Once off is non-zero, 
 an element getter [...] 
...
X-Headers-End: 1wQ3Wm-0004O7-ED
X-Mailman-Approved-At: Thu, 21 May 2026 14:16:34 +0000
Subject: [Openipmi-developer] [PATCH 01/11] params: bound array element
...
X-Spamd-Result: default: False [-6.11 / 15.00];
 ...
 m,m:linux-serial@vger.kernel.org,m:rui.zhang@intel.com,m:hca@linux.ibm.com,m:apparmor@lists.ubuntu.com,m:virtualization@lists.linux.dev,m:linux-hardening@vger.kernel.org,m:hare@suse.de,m:benjamin.berg@intel.com,m:daniel.lezcano@kernel.org,m:andriy.shevchenko@linux.intel.com,m:tiwei.btw@antgroup.com,m:dvyukov@google.com,m:john.johansen@canonical.com,m:netdev@vger.kernel.org,m:stable@vger.kernel.org,m:vkoul@kernel.org,m:dmaengine@vger.kernel.org,m:pbonzini@redhat.com,m:johannes@sipsolutions.net,m:linuxppc-dev@lists.ozlabs.org,s:lists@lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[lists.sourceforge.net:dkim,lists.sourceforge.net:rdns,lists.sourceforge.net:helo,suse.com:email,iscas.ac.cn:email]
X-Rspamd-Queue-Id: 57A1A5A7097
