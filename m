...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id D352C8DF24
	for <lists+openipmi-developer@lfdr.de>; Wed, 14 Aug 2019 22:45:39 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <openipmi-developer-bounces@lists.sourceforge.net>)
	id 1hy09J-0001QT-QF; Wed, 14 Aug 2019 20:45:37 +0000
...
Subject: [Openipmi-developer] [PATCH v5 00/18] compat_ioctl.c removal,
 part 2/3
