...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 26564896824
	for <lists+openipmi-developer@lfdr.de>; Wed,  3 Apr 2024 10:15:33 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-3.v29.lw.sourceforge.com)
	by sfs-ml-3.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <openipmi-developer-bounces@lists.sourceforge.net>)
	id 1rrvmJ-0004Hi-HP;
	Wed, 03 Apr 2024 08:15:27 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-3.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <arnd@kernel.org>) id 1rrvmG-0004HX-2f
 for openipmi-developer@lists.sourceforge.net;
 Wed, 03 Apr 2024 08:15:24 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=3gMAaFs+bSPrX/k779VXo6Uh60Aa9EMp38aXGaD0RAA=; b=aodY7wEtYGibguK55KYSu8f9E/
 nAWZE3pj6Jd4YlX2oDfZU2AclvO//Qv36EEf4XG3KWyt1EFoQRGbDWXeggUowWwXblYE/LXtzRytv
 /+l2zlr+1WJIiHNjRe3YUzLkXR4HZWAEXIH4K1qFFmqvFgLl7mLV+GnXniQ6VEOVqh+M=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=3gMAaFs+bSPrX/k779VXo6Uh60Aa9EMp38aXGaD0RAA=; b=L6y+qAzIjA6ZYdipUXdTccLIao
 Q7l3nLHXbn2iDCNkOYYUwVXPk95vfDUysJM1Yaww5j0Dl7B/Yb7vZoDRlR/YAVStApXfCfMFFTbJe
 m+NVJQ3c8E/8rOPG66LzZUj9jI6ixXaiU4Q/wayLfgcjGuDHk5XQ8zvtDH/JbFS+/+84=;
Received: from sin.source.kernel.org ([145.40.73.55])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1rrvmE-0003Um-Pa for openipmi-developer@lists.sourceforge.net;
 Wed, 03 Apr 2024 08:15:24 +0000
Received: from smtp.kernel.org (transwarp.subspace.kernel.org [100.75.92.58])
 by sin.source.kernel.org (Postfix) with ESMTP id 61662CE20AC;
...
To: linux-kernel@vger.kernel.org, Corey Minyard <minyard@acm.org>,
 ...
 Salil Mehta <salil.mehta@huawei.com>, Tony Lindgren <tony@atomide.com>,
...
X-Spam-Report: Spam detection software,
 ...
 Content preview: From: Arnd Bergmann <arnd@arndb.de> When building with
 CONFIG_OF
 and/or CONFIG_ACPI disabled but W=1 extra warnings enabled, a lot of driver
 cause a warning about an unused ID table:
 drivers/char/tpm/tpm_ftpm_tee.c:356:34:
 error: unused variable 'of_ftpm_tee_ids' [-Werror,-Wunused-const-variable]
...
X-Headers-End: 1rrvmE-0003Um-Pa
Subject: [Openipmi-developer] [PATCH 33/34] drivers: remove incorrect
