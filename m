...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id D36E77B4E84
	for <lists+openipmi-developer@lfdr.de>; Mon,  2 Oct 2023 11:02:55 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <openipmi-developer-bounces@lists.sourceforge.net>)
	id 1qnEpI-0006St-Fo;
	Mon, 02 Oct 2023 09:02:52 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <gregkh@linuxfoundation.org>) id 1qnEpG-0006Sh-JB
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=AX93sLvcrd6tJrae8auvW0+fJziM4fCii67Rek5eZuc=; b=GWbfK4T0gt1+XAJHUhWrfONy/l
 OjpemTCsHwVIgst7BL46RyG5D5gzn4JDw1+DJ+fS4IzWJkXgnrjc6L3pDmQnvKA41ScjkZ/Efi3xN
 cn8YB+u3IyZvbB9l84e8XTI+x8cpsOhXjvPU3YTu0pkr9vMJWJ5B9GVXvmKtOe82BzOc=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=AX93sLvcrd6tJrae8auvW0+fJziM4fCii67Rek5eZuc=; b=ElOPnzTqs/+Z/wzfZSBK0QIZcy
 ZJxkaXhPwuk3HbOMHRFHN74xVEBP5+gJch96fvTsHzgvPwb7c8pSQWpuPFKSaDER4pzr0yc0HOYzN
 mv256/jZqYKTwxGG3/SHdS+J9hopwbpCxNKjwDeYPsPPGZw491NJeOtvTr4MnhhdYZXk=;
Received: from sin.source.kernel.org ([145.40.73.55])
 by sfi-mx-1.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1qnEpF-00FQ9W-Kc for openipmi-developer@lists.sourceforge.net;
 Mon, 02 Oct 2023 09:02:50 +0000
...
X-Spam-Report: Spam detection software, running on the system "util-spamd-2.v13.lw.sourceforge.com",
 ...
 Content preview:  On Mon, Oct 02, 2023 at 08:47:53AM +0000, Christophe Leroy
    wrote: > > > Le 02/10/2023 à 10:17, Jiri Slaby a écrit : > > On 28. 09. 23,
    15:21, Joel Granados via B4 Relay wrote: > >> From: Joel Granados [...] 
...
X-Headers-End: 1qnEpF-00FQ9W-Kc
Subject: Re: [Openipmi-developer] [PATCH 04/15] tty: Remove now superfluous
...
> Le 02/10/2023 =E0 10:17, Jiri Slaby a =E9crit=A0:
...
> >> ---
> >> =A0 drivers/tty/tty_io.c | 3 +--
> >> =A0 1 file changed, 1 insertion(+), 2 deletions(-)
> >>
> >> diff --git a/drivers/tty/tty_io.c b/drivers/tty/tty_io.c
> >> index 8a94e5a43c6d..2f925dc54a20 100644
> >> --- a/drivers/tty/tty_io.c
> >> +++ b/drivers/tty/tty_io.c
> >> @@ -3607,8 +3607,7 @@ static struct ctl_table tty_table[] =3D {
> >> =A0=A0=A0=A0=A0=A0=A0=A0=A0 .proc_handler=A0=A0=A0 =3D proc_dointvec,
> >> =A0=A0=A0=A0=A0=A0=A0=A0=A0 .extra1=A0=A0=A0=A0=A0=A0=A0 =3D SYSCTL_ZE=
RO,
> >> =A0=A0=A0=A0=A0=A0=A0=A0=A0 .extra2=A0=A0=A0=A0=A0=A0=A0 =3D SYSCTL_ON=
E,
> >> -=A0=A0=A0 },
> >> -=A0=A0=A0 { }
> >> +=A0=A0=A0 }
...
> > Why to remove the comma? One would need to add one when adding a new en=
try?
> =
