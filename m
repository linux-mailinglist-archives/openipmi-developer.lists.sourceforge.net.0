...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id DE5CFA07875
	for <lists+openipmi-developer@lfdr.de>; Thu,  9 Jan 2025 15:03:15 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <openipmi-developer-bounces@lists.sourceforge.net>)
	id 1tVt7p-0004DH-NH;
	Thu, 09 Jan 2025 14:03:05 +0000
Received: from [172.30.29.66] (helo=mx.sourceforge.net)
 by sfs-ml-3.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <joel.granados@kernel.org>) id 1tVsPP-0000R1-7e
 for openipmi-developer@lists.sourceforge.net;
 Thu, 09 Jan 2025 13:17:10 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=MM9nUyvPI3g+n454gbMuIaeSHyo4QaJd01aFjs5/3J8=; b=JcdOVaQzMJaNKTs1NvlkjJtizC
 vTmrkjqq0s0kK3fpXcLWkCY+pi0fyB86nPNF9MVofcyvyRQLPcUOjGvxPJoWVxpc9E2l4c3CEwvm6
 fVzP+3rmIT62JN2XrKZpjNZArU3Q3BgCWe4QUakcgWJRmAC9G4LFD5bGUCo+VVi0R6DI=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Owner:List-Archive; bh=MM9nUyvPI3g+n454gbMuIaeSHyo4QaJd01aFjs5/3J8=; b=Q
 s0MeGMypzZgAU8PZCdFnKwIz2RBdI7jHSWm1Bxb11OkDBQ+Q6f507oo0ySZ2DNXCtfHGhCay9LwzI
 OtNScMipOA0EXKXwzzwQ9IULPmdfJ3X3CgBTl8kNBmg6Tp7EqR5IW8yM5jS2t63qBupmgMCm9fdQX
 e0cM0VyrJaKx3EwU=;
Received: from nyc.source.kernel.org ([147.75.193.91])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1tVsPM-0003ar-1G for openipmi-developer@lists.sourceforge.net;
 Thu, 09 Jan 2025 13:17:10 +0000
...
X-Spam-Report: Spam detection software,
 ...
 Content preview:  Add the const qualifier to all the ctl_tables in the tree
 except the ones in ./net dir. The "net" sysctl code is special as it modifies
 the arrays before passing it on to the registration function. Constifying
 ctl_table structs will prevent the modification of proc_handler function
 pointers as the arrays would reside in .rodata. This is made possible after
 commit 78eb4ea25cd5 ("sysctl: treewide: [...] 
...
X-Headers-End: 1tVsPM-0003ar-1G
X-Mailman-Approved-At: Thu, 09 Jan 2025 14:03:03 +0000
Subject: [Openipmi-developer] [PATCH] treewide: const qualify ctl_tables
 where applicable
