...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	bh=aJA2YQy48wDcQqm+IFodwVjQlCefuPgo5/FOiMnQOPk=; b=aDS1NPT3JwMhZQ6k+TRik4YNoh
	2WGyjT4vkOQd4tCQZVTp6BscFGhxaHa/3S7VDrQ5gKwYrs8Q7zhVLL1I0FgjX3OrCqTA+PfdF1038
	S9Abv244rczeJzC2XhnYab7nK3GooitbgFtS/54mLUfPxAlHhN4dU3OwstB7oX46DaHE=;
...
Received: from [172.30.29.66] (helo=mx.sourceforge.net)
 ...
 (envelope-from <kees@kernel.org>) id 1wQ3Wv-0007n4-M4
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=tKkpPR3jQHJlzhq8UmH+Jth3VGTLnlZlrxb+8EBuqYs=; b=XBsQGEB4zomJV6JWoDhqZUf9Q5
 HiKOf5hPrewbdKd4gBtxwf2FmA0UhtZWqZDym1Wik10+6lwpvQgImA+6xYhKb0qBs1EgMb8vMzltp
 2Q9BVyhg++WdFy+eAUTxomDdSzI69wpUpysFg0R9nQZaSz8PV6HswtKEupI8YZxW4chs=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=tKkpPR3jQHJlzhq8UmH+Jth3VGTLnlZlrxb+8EBuqYs=; b=NVu4Iic5lgGw1TKX5xiB5i3UWi
 LpdkrAfXWej0KtGJzAx7X6uN+OpbNjZZxQ7Dq1VQLi0WmR4/YHVdQlEY1fKDWuXNvEphXjPRZKsCx
 lrSE3/vi+Yx5b/Jwl+uHAJxWW27HZNA52wtMBCRFl1O9eqXwCyQ0atRGKIjPVjsO9vUs=;
Received: from sea.source.kernel.org ([172.234.252.31])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1wQ3Wp-0004OM-0N for openipmi-developer@lists.sourceforge.net;
 Thu, 21 May 2026 13:33:38 +0000
...
X-Spam-Report: Spam detection software,
 ...
 Content preview:  Using Coccinelle,
 rewrite every struct kernel_param_ops initializer
 that sets .get into a DEFINE_KERNEL_PARAM_OPS-family macro invocation, for
 example: @@ declarer name DEFINE_KERNEL_PARAM_OPS; identifier OPS; expression
 SET, GET; @@ - const struct kernel_param_ops OPS = { - .set = SET, - .get
 = GET, - }; + DEFINE_KERNEL_PARAM_OPS(OPS, SET, GET); 
...
X-Headers-End: 1wQ3Wp-0004OM-0N
X-Mailman-Approved-At: Thu, 21 May 2026 14:16:34 +0000
Subject: [Openipmi-developer] [PATCH 04/11] treewide: Convert struct
