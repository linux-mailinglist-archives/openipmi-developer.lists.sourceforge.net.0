...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id B8A088B367A
	for <lists+openipmi-developer@lfdr.de>; Fri, 26 Apr 2024 13:25:42 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-3.v29.lw.sourceforge.com)
	by sfs-ml-3.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <openipmi-developer-bounces@lists.sourceforge.net>)
	id 1s0Jho-0008Ea-Oe;
	Fri, 26 Apr 2024 11:25:29 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-1.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <SRS0=aiH6=L5=xs4all.nl=hverkuil@kernel.org>)
 id 1rzYh1-0002ez-F3 for openipmi-developer@lists.sourceforge.net;
 Wed, 24 Apr 2024 09:13:31 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=OqoGuh2/GqE2XTWl+CiZMSDZf0dLfkduJzYR3hwLsSw=; b=l3JHCQnbPIurRkp2nTpSUxiT3M
 DqDjqPSlRRwyN02xHps51DKzRIRjHq3CeLLWw5U1++rSXYAGX9LNqugEv4CuEaYenBD3myVTtHuYt
 zCstx4XhptvMpfk5enwlT6rYTa+wGNheu4dAaGj4ul072VVqAsSjOZ9hoVx8NOCsiI9w=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=OqoGuh2/GqE2XTWl+CiZMSDZf0dLfkduJzYR3hwLsSw=; b=PhPVq4i1A06zhcwVYGbKDzHnjQ
 xR+PAzzE4BiSXtoWER8p3X3igfImT6AA1SN4yOgcpQqn+KnOo1FPmjCYZSrWx0AYRPlPFbBQG/6d9
 /3COMKgO9jQS+xXCUWZz83L0B/nfuw2R51GOfTlgFYG7IR199d86CSkaLJDWhKUofnAg=;
Received: from sin.source.kernel.org ([145.40.73.55])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1rzYgx-0007aZ-IC for openipmi-developer@lists.sourceforge.net;
 Wed, 24 Apr 2024 09:13:31 +0000
Received: from smtp.kernel.org (transwarp.subspace.kernel.org [100.75.92.58])
 by sin.source.kernel.org (Postfix) with ESMTP id 6AA76CE136A;
...
X-Spam-Report: Spam detection software,
 ...
 Content preview:  On 27/03/2024 17:03, Allen Pais wrote: > The only generic
 interface to execute asynchronously in the BH context is > tasklet; however,
 it's marked deprecated and has some design flaws. To > replace ta [...] 
 ...
 for more information. [URIs: ir.dev]
 0.0 SPF_HELO_NONE          SPF: HELO does not publish an SPF Record
 -0.0 SPF_PASS               SPF: sender matches SPF record
 0.2 HEADER_FROM_DIFFERENT_DOMAINS From and EnvelopeFrom 2nd level
 mail domains are different
X-Headers-End: 1rzYgx-0007aZ-IC
X-Mailman-Approved-At: Fri, 26 Apr 2024 11:25:27 +0000
